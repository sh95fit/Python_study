...
from Qt_Design_02 import Ui_btn_Click
import sys
class MainWindow(QMainWindow) :
    def __init__(self):
        ...
        # ()를 통해 함수를 호출하게 되면 버튼이 누르기 전에 호출되어버림! 클릭되었을 때 click 함수 실행을 위해 () 생략!
...
if __name__ == "__main__":
    ...
    # QApplication을 사용자가 끌 때까지 유효하게 가지고 있다가 사용자가 끄면 파이썬도 같이 종료되도록 하는 소스
    sys.exit(app.exec())
